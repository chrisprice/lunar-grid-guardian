...
* **Total Grid Demand:** Displays the current total power being demanded by all active colony systems.  
  * *Visual Style:* This could be, for example, an analog-style gauge.  
* **Total Grid Supply:** Displays the current total power being supplied by all active generation sources.  
...
* **Solar Power Level Output:** Shows the current power being generated by the solar arrays (e.g., in kW).  
...
* **Reactor Power Level Output:** Shows the current power being generated by the reactor (e.g., in kW or as a percentage of max output).  
  * *Visual Style:* Could be an analog-style gauge.  
...
* **Life Support Power Level:** Shows the current power being consumed by the Life Support system.  
  * *Visual Style:* Could be an analog-style gauge.  
...
* **Power Demand:** Comms system draws a constant power load from the grid when online (defined by CommsPowerDemand in Table 1). This load contributes to the "Total Grid Demand" on the GO Panel.  
* **Event Warnings:**  
...
* **Power Demand:** Operations draw a constant power load from the grid when online (defined by OperationsBasePowerDemand in Table 1). This load spikes significantly (magnitude OperationsDockingSpikePower, duration OperationsDockingSpikeDuration in Table 1\) during the docking process for a **Boost Item** supply drop.  
...
* **Operations Power Level:** Shows the current power being consumed by the Operations system. This will show a base level when online and a spike during docking.  
  * *Visual Style:* Could be an analog-style gauge.  
...
| 1.3 | Nominal System Power Capacity | SystemNominalPowerPnom | kW | Baseline total rated power of generation; may be dynamic. |
...
| 2.2.2.1 | Life Support \- Base Power Demand | LifeSupportBasePowerDemand | kW | Initial power demand. |
| 2.2.2.1 | Life Support \- Power Demand Increase Rate | LifeSupportPowerDemandIncrease | kW per in-game day | How much power demand increases each game day. |
| 2.2.2.2 | Comms \- Power Demand | CommsPowerDemand | kW | Constant power load when Comms are online. |
...
| 2.2.2.3 | Operations \- Base Power Demand | OperationsBasePowerDemand | kW | Power load when Operations online (not docking). |
| 2.2.2.3 | Operations \- Docking Power Spike Magnitude | OperationsDockingSpikePower | kW (absolute increase) | Additional kW drawn during docking. |
